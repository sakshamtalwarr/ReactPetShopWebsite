...
const App = () => {
  ...
  const handleLogin = (username, password) => {
    ...
    if (username === 'work.sakshamtalwar@gmail.com' && password === 'ABhp@28112003') {
      setIsLoggedIn(true);
      setIsAdmin(true);
        ...
        >
          ...
          {showAiPrompt && (
            <div className="absolute right-full mr-4 p-2 bg-gray-800 text-white text-sm rounded-md shadow-md opacity-0 animate-fadeInRight max-w-[180px] text-center flex items-center justify-between">
              ...
              <div className="absolute right-0 top-1/2 -mr-2 w-0 h-0 border-t-[6px] border-b-[6px] border-l-[6px] border-t-transparent border-b-transparent border-l-gray-800 transform -translate-y-1/2"></div>
            </div>
          )}
        </button>
...
const AppointmentPage = ({ setCurrentPage }) => {
  ...
  const googleFormUrl = "https://docs.google.com/forms/d/e/1FAIpQLScOUuO7Fww0-EG_4Z5KRHVqyL8UeiFx3Jcbkd9NHaCqGEMZWw/viewform?embedded=true";
      ...
      <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl shadow-2xl text-center border-t-4 border-green-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-100 p-8 rounded-lg shadow-md border-l-4 border-blue-400">
            <h3 className="text-3xl font-bold text-gray-900 mb-4 font-playfair">Manage <span className="text-blue-600">Products</span></h3>
          ...
          <div className="bg-gray-100 p-8 rounded-lg shadow-md border-l-4 border-yellow-400">
            <h3 className="text-3xl font-bold text-gray-900 mb-4 font-playfair">Edit <span className="text-yellow-600">Website Content</span></h3>
            <p className="text-gray-700 mb-6">
